...
bin101@bin101-Inspiron-16-5635:~/code/LinuxProgrammingInterface/sec09/prob4$ sudo chown root ./a.out
bin101@bin101-Inspiron-16-5635:~/code/LinuxProgrammingInterface/sec09/prob4$ sudo chmod u+s ./a.out

実行結果
bin101@bin101-Inspiron-16-5635:~/code/LinuxProgrammingInterface/sec09/prob5$ ./a.out
a: seteuid
...
bin101@bin101-Inspiron-16-5635:~/code/LinuxProgrammingInterface/sec09/prob5$ ./a.out 0
a: seteuid
uid=1000 euid=0 suid=0
uid=1000 euid=1000 suid=0
uid=1000 euid=0 suid=0
